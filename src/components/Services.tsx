      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <Card 
              key={index} 
              className="group hover:border-electric/40 transition-all duration-300 hover:shadow-lg hover:shadow-electric/10"
            >
              <CardContent className="p-6">
                <div className="mb-6">
                  <div className="w-12 h-12 bg-electric/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-electric group-hover:text-electric-foreground transition-colors">
        ...
        {/* Stats Section */}
        <div className="mt-20 bg-card rounded-2xl p-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl md:text-4xl font-bold text-electric mb-2">$25k</div>
              <div className="text-muted-foreground">Avg. Project Value</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-electric mb-2">4-8</div>
            ...
            <div>
              <div className="text-3xl md:text-4xl font-bold text-electric mb-2">250%</div>
